...
impl ReadableStorageTraits for FilesystemStoreDIO {
...
impl WritableStorageTraits for FilesystemStoreDIO {
...
impl ReadableWritableStorageTraits for FilesystemStoreDIO {
    // fn mutex(&self, key: &StoreKey) -> Result<StoreKeyMutex, StorageError> {
    //     Ok(self.locks.mutex(key))
    // }
}

impl ListableStorageTraits for FilesystemStoreDIO {
